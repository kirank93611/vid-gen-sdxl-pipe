  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        lime: "bg-[var(--studio-lime)] text-black font-semibold shadow-[0_0_24px_rgba(204,255,0,0.25)] hover:brightness-105 active:scale-[0.98]",
        chip: "h-9 rounded-lg border border-border bg-card/80 px-3 text-xs text-muted-foreground hover:border-[var(--studio-lime)]/40 hover:text-foreground",
      },
      size: {
